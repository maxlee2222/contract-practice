...
contract Exchange is ERC20 {
    ...
    function addLiquidity(uint256 _amount) public payable returns (uint256) {
        ...
        if (cryptoDevTokenReserve == 0) {
            ...
            require(_amount >= cryptoDevTokenAmount, "Anount of tokens sent is less than minimum tokens required");
    ...
    function cryptoDevToEth(uint256 _tokenSold, uint256 _minEth) public payable {
        uint256 tokenReserve = getReserve();
